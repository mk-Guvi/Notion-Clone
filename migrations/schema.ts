import { pgTable, foreignKey, pgEnum, uuid, text, jsonb, integer, boolean, timestamp, bigint } from "drizzle-orm/pg-core"
...
export const files = pgTable("files", {
	...
	workspaceId: uuid("workspace_id").references(() => workspace.id, { onDelete: "cascade" } ).references(() => workspaces.id, { onDelete: "cascade" } ),
